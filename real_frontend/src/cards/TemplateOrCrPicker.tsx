 ...
 * ORDER: the agent's recommended CRs come first, then Template ID. The Figma
 * frame has them the other way round; the client asked for the swap on the call
 * of 2026-08-30, on the grounds that the recommendations are the answer most
 * people want and the template is the fallback. Recorded here because it is a
 * deliberate divergence from the design file, not a mistake.
 *
