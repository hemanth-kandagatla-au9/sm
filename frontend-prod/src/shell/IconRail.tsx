  ...
  return (
    ...
    >
      <div className="flex w-full flex-col gap-5">
        ...
        >
          ...
          >
            {railExpanded ? (
              ...
              <Icon src="jnj-logo.svg" width={36} height={36} alt="Johnson &amp; Johnson" />
            )}
            <button
              type="button"
              onClick={toggleRail}
        ...
        <div className={cn("flex w-full flex-col items-center", railExpanded && "px-4")}>
          <ul
            className={cn(
              "flex flex-col gap-4",
          ...
          >
            {RAIL_ITEMS.map((item, i) => (
              <li key={item.src} className={railExpanded ? "w-full" : undefined}>
                <button
                  type="button"
