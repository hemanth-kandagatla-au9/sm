...
export function CrIntakeForm({ props, respond, pending }: AgentCardProps<"crIntakeForm">) {
  ...
  useEffect(() => {
    ...
    apiGet<{ target_systems: string[] }>(
      `/api/target-systems?platform=${encodeURIComponent(platform)}`,
      ctrl.signal,
    )
  ...
  function submit() {
    ...
    setSubmitted(true);
    respond(["Create a change request.", ...lines].join("\n"));
  }
      ...
      <div className="flex w-full flex-col gap-5">
        ...
        <div className="flex w-full items-center justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            >
              <span className="text-16 font-text font-medium text-ink-600">Cancel</span>
            </button>
            <button
              type="button"
              onClick={submit}
            ...
            >
              <span className="text-16 font-text font-medium text-surface">Submit</span>
              <span
                aria-hidden
